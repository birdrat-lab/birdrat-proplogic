...
def _format_beam_layer(layer) -> str:
    return (
        ...
        f"suffix_seen={layer.suffix_candidates_seen_by_suffix},"
        f"suffix_keep={layer.suffix_survivors_by_suffix},"
        f"schema_inst=({layer.schema_instantiation_attempts},{layer.schema_instantiation_valid},"
        f"{layer.schema_instantiation_closed},{layer.schema_instantiation_schematic},"
        f"{layer.schema_instantiation_exact_target},{layer.schema_instantiation_exact_region},"
        f"{layer.schema_instantiation_exact_suffix}),"
